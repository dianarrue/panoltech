...
function init(){
	...
	//Cargamos los items al combobox Herramienta
	$.post("../ajax/prestamo.php?op=SelectHerramienta", function(r){
	            $("#idherramienta").html(r);
	            $('#idherramienta').selectpicker('refresh');
	});
...
{
	bootbox.confirm("¿Devolución de herramienta?", function(result){
		if(result)
        {
